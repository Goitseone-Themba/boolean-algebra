...
computer friendly version of the Karnaugh map method. The method is a
deterministic algorithm that can be programmed and is effective for any
number of variables \cite{rosen2013}.
...
\begin{description}
    ...
    cares in binary and sorting them into groups according to the number ofS
