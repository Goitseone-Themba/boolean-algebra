...
or $-$, these are commonly used in truth tables \cite{floyd2015}.
...
\begin{description}
    \item[Invalid input combinations.] In a Binary Coded Decimal
...
freedom to form larger groupings, implicants  which directly
reduces the number of logic gates in the final circuit. A key rule applies,
a grouping may include don't cares to enlarge it, but it cannot
consist entirely of don't cares, as such a group covers no required
output.
